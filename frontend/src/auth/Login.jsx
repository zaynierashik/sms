...
import LoginUser from '../../src/assets/ph_user.png';
import AuthModel from '../../src/assets/Login-Img.png';
                ...
                <div className="flex items-center justify-center">
                    <form className="w-full max-w-md space-y-8 px-0.5">
                        <div className="flex flex-col items-center mb-6">
                            <img src={LoginUser} alt="User Icon" className='size-7 mb-4' />
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <input id="email" className="form-input w-full p-3 rounded border border-gray-300" type="email" placeholder="Username" />
                            </div>
                            <div>
                                <label className="mb-1 block text-base font-medium" htmlFor="password">Password</label>
                                <input id="password" className="form-input w-full p-3 rounded border border-gray-300" type="password" autoComplete="on" placeholder="Password" />
                            </div>
                        </div>
