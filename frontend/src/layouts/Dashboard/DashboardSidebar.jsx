...
function DashboardSidebar() {
	...
	return (
		<aside
			className={`fixed mt-16 flex flex-col text-sm lg:mt-0 top-0 px-5 left-0 bg-white text-gray-300 h-screen transition-all duration-300 ease-in-out z-50 shadow-2xl border-r border-gray-200 
